...
#define START_MASTERNODE_PAYMENTS_TESTNET 1496974804000 // June 9, 2017 2:20:04 AM GMT
...
inline int64_t GetMNCollateral(int nHeight) { return 10000; }  // No change for now.
