...
static const int64_t PEPE_STAKE_V2_SWITCH_HEIGHT = 20000;
...
public:
    ...
    bool ReadFromDisk(unsigned int nFile, unsigned int nBlockPos, bool fReadTransactions=true)
    {
        ...
        // Check the header
        if (fReadTransactions && IsProofOfWork() && !CheckProofOfW// Copyright (c) 2009-2010 Satoshi Nakamoto
// Copyright (c) 2009-2012 The Bitcoin developers
// Copyright (c) 2012 Litecoin Developers
// Copyright (c) 2013 Peercoin Developers
// Copyright (c) 2014 DarkCoin Developers
...
#endif
䈠佌䭃偟佒䙏佟彆呓䭁㭅 †素ਊ††湵楳湧摥椠瑮䜠瑥瑓歡䕥瑮潲祰楂⡴ 潣獮ੴ††੻††††敲畴湲⠠渨汆条⁳…䱂䍏彋呓䭁彅久剔偏⥙㸠‾⤱਻††੽ †戠潯⁬敓却慴敫湅牴灯䉹瑩用獮杩敮⁤湩⁴䕮瑮潲祰楂⥴ †笠 †††椠⁦渨湅牴灯䉹瑩㸠ㄠ਩††††††敲畴湲映污敳਻††††䙮慬獧簠‽渨湅牴灯䉹瑩‿䱂䍏彋呓䭁彅久剔偏⁙›⤰਻††††敲畴湲琠畲㭥 †素ਊ††潢汯䜠湥牥瑡摥瑓歡䵥摯晩敩⡲ 潣獮ੴ††੻††††敲畴湲⠠䙮慬獧☠䈠佌䭃卟䅔䕋䵟䑏䙉䕉⥒਻††੽ †瘠楯⁤敓却慴敫潍楤楦);
