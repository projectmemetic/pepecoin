...
inline unsigned int ReceiveFloodSize() { return 1000*GetArg("-maxreceivebuffer", 32*1000); }
...
extern CCriticalSection cs_alreadyaskedfor;
...
public:
    ...
    std::vector<uint256> vBlockInventorySent;
